...
Wir werden uns in der Lektion [Teiler und Vielfache](3-teiler.qmd) ausführlich mit der Teilbarkeit natürlicher Zahlen befassen.
...
Wir werden in der nächsten Lektion [Zahlenbereiche und Zahlensyteme](2-mengen.qmd) sehen, wie wir die Funktion `range()` korrekt anwenden.
...
Genauso können wir Mathematik nicht lernen, indem wir ein Tutorial (wie dieses hier) oder ein Lehrbuch über Mathematik lesen.
...
Ich werde dir hier ein paar Aufgaben vorgeben, die du mit etwas Nachdenken sicher lösen kannst.
