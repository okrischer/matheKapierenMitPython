...
Mit diesen Regeln können wir jetzt eine Dualzahl in Python in eine Dezimalzahl konvertieren:
...
2. Ausgabe von `x` im Binärformat (wir verwenden hierzu einen sogenannten `f-string` für engl. *formatted string*) und der Menge der gesetzten *bits*.
