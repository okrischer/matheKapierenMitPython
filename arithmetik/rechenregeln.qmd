...
Wir werden uns in der Lektion [Teiler und Vielfache](teiler_vielfache.qmd) ausführlich mit der Teilbarkeit natürlicher Zahlen befassen.
...
Die Multiplikation von Binomen führt zu den **Binomischen Formeln**.
Wenn wir zwei Bimome miteinander multiplizieren, z.B. $(a+b) \cdot (a-b)$, dann heißen die daraus entstehenden Gleichungen *binomische Gleichungen 2. Grades*.
...
In Python können wir solche Summen auf verschiedene Weisen berechnen:
...
Wir werden in der Lektion [Zahlenbereiche und Zahlensyteme](zahlen.qmd) sehen, wie wir die Funktion `range()` korrekt anwenden.
